<template>
  <div id="app">
    <div v-if="this.$route.name == 'Painel_Clinica'">
      <!-- 
      Insere na pagina:
      o botão de voltar,
      ...
      <h2 id= "nome_pag"><strong>MedCenter<br/>Painel da Clínica</strong></h2>

      <nav class = "Rectangle2">
        <div>
          <h4>Gerenciar médicos</h4>
          <br/><br/><br/> 
          <img width= "45%" height= "30%" src="../assets/clinica2.png">
          <button name="gerenciar" id = "gerenciar">Gerenciar</button>
        </div>
      </nav>
